...
## Project Structure
    ...
    ├── grouping_small_scre_37555  # Django project configurations
...
1. Clone this repo and `cd grouping_small_scre_37555`
...
2. Clone this repo and `cd grouping_small_scre_37555`
